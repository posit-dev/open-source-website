#!/bin/bash
# Fix .markdown files that weren't processed by the porting script
# Converts author -> people, adds image/ported_from/port_status
# Usage: ./scripts/fix-markdown-files.sh

set -e

for FILE in $(find content/blog -name "index.markdown"); do
