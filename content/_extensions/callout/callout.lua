...
-- Transforms .callout-* divs into styled HTML before Quarto converts them
-- to plain blockquotes in hugo-md output.
...
-- SVG icons (tabler-icons style, 24x24)
local icons = {
  ["info-circle"] = '<svg class="callout-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>',
  ["lightbulb"] = '<svg class="callout-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M12 2a7 7 0 0 0 -4 12.9l0 .1v1h8v-1l0 -.1a7 7 0 0 0 -4 -12.9"/></svg>',
  ...
  ["alert-octagon"] = '<svg class="callout-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 9v4"/><path d="M7.86 2h8.28l5.86 5.86v8.28l-5.86 5.86h-8.28l-5.86 -5.86v-8.28z"/><path d="M12 16h.01"/></svg>',
  ["alert-circle"] = '<svg class="callout-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>',
}
...
-- Render pandoc blocks to HTML string
...
function Div(div)
  ...
  local body_html = blocks_to_html(body_content)

  local blocks = pandoc.List()

  if collapse == "true" then
    -- Collapsible callout using <details>/<summary>
    blocks:insert(pandoc.RawBlock("html",
      '<details class="callout ' .. cls .. '">\n' ..
