...
description: 'We were joined by Oscar Baruffa, Senior Analytics Manager at IDH.
  ...
  My role mostly is to try and not just prioritize work but try and help them uncover where there''s

  work that needs to be done. Or if there''s a dilemma, try and break down, well, what if we go this direction? How bad will it be if this happens? Or how good will it be if this happens? Can we weigh risk like this?
...
external:  # updated automatically, do not edit
  ...
  has_captions: true
  language: en
  last_updated: '2026-03-04T14:51:25.988419+00:00'
  like_count: 17
  playlist: ''
  tags: []
