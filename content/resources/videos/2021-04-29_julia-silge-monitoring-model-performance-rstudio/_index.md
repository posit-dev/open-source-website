...
description: '0:00 Project introduction
  ...
  1:50 Overview of the setup code chunk

  3:05 Getting new data

  4:05 Getting model from RStudio Connect using httr and jsonlite

  6:20 Bringing in metrics

  9:45 Using the pins package

  10:50 Using boards on RStudio Connect

  13:30 Benefits of using pins

  14:00 Visualizations using ggplot and plotly

  17:00 Knitting the flexdashboard

  18:10 Project takeaways
...
external:  # updated automatically, do not edit
  ...
  has_captions: true
  language: en
  last_updated: '2026-03-04T14:51:28.310951+00:00'
  like_count: 187
  people:
  - Julia Silge
  playlist: ''
