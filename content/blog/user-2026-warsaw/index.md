...
And this community is ours. From joining my very first useR! online in 2022, through to Salzburg in 2024 - SatRdays London in between, the R Project Sprint in Warwick (UK) in 2023, the R Dev Days since, and of course posit::conf(2024) Seattle, posit::conf(2025) Atlanta, and Japan.R 2025... I may not have been part of this community for the most number of years, but I've certainly appreciated its warmth and openness.
...
There are many people I've not mentioned by name - that's just to prevent this entire post from being a name-drop. I've enjoyed speaking to every one of you. There is so much talent out there, and I look forward to catching up again and marvelling at all you've been working on!
