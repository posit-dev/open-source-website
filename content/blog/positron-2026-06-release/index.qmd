...
people:
  - Julia Silge
description: >
  Highlights from the 2026.06 release of Positron, including faster startup and migrating to Posit Assistant.
image: "featured.svg"
...
![](posit-assistant.gif){fig-align="center" fig-alt="Posit Assistant in Positron, Posit's unified data-science AI assistant, which is replacing the older Positron Assistant."}
...
{{< video https://www.youtube.com/embed/Y9P2nlFXKnQ >}}
...
![](packages-pane.gif){fig-align="center" fig-alt="The Positron Packages pane showing the attached category filter, the Item Size toggle switching between compact rows and a card view with package descriptions, and how to update a package."}
...
![](inline-output.gif){fig-align="center" fig-alt="A Quarto document in Positron showing inline output beneath an executed code cell, with the new toolbar button for managing output."}
...
{{< video https://www.youtube.com/embed/QIYyeuZ_ISY >}}
