...
The Hugging Face [model hub](https://Hugging%20Face.co/models) lets you access (and download) all required files ([weights](https://Hugging%20Face.co/gpt2/blob/main/model.safetensors) and [tokenizer](https://Hugging%20Face.co/gpt2/blob/main/tokenizer.json)) directly from the [GPT-2 page](https://Hugging%20Face.co/gpt2/tree/main). All files are versioned; we use the most recent version.
