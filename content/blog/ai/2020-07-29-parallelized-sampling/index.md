...
<img src="images/d1.jpg" style="width:50.0%;height:50.0%" alt="step 1" /> .

After deleting $r_1$ from the sample space after it's hit, step $j = 2$ will look like this:

<img src="images/d2.jpg" style="width:48.0%;height:45.0%" alt="step 2" /> ,
...
<img src="images/d3.jpg" style="width:40.0%;height:30.0%" alt="step 3" /> ,
...
<figure>
<img src="images/tree.jpg" style="width:60.0%;height:40.0%" alt="." />
...
We hope you have enjoyed reading this blog post! If you wish to learn more about `sparklyr`, we recommend visiting [sparklyr.ai](https://sparklyr.ai), [spark.rstudio.com](https://spark.rstudio.com), and some of the previous release posts such as [sparklyr 1.3](https://blog.rstudio.com/2020/07/16/sparklyr-1-3/) and [sparklyr 1.2](/blog/ai/2020-04-21-sparklyr-1.2.0-released/). Also, your contributions to `sparklyr` are more than welcome. Please send your pull requests through [here](https://github.com/sparklyr/sparklyr/pulls) and file any bug report or feature request in [here](https://github.com/sparklyr/sparklyr).
