...
If you're new to eager execution, don't worry: As every new technique, it needs some getting accustomed to, but you'll quickly find that many tasks are made easier if you use it. A simple yet complete, template-like example is available as part of the [Keras documentation](https://tensorflow.rstudio.com/tutorials/advanced/)^[Note: this link was updated as of November 29th, 2019, to point to the most up-to-date version.].
