...
description: "Advanced applications like generative adversarial networks, neural style
  transfer, and the attention mechanism ubiquitous in natural language processing
  used to be not-so-simple to implement with the Keras declarative coding paradigm.
  Now, with the advent of TensorFlow eager execution, things have changed. This post
...
<aside>
[![](attention.png){width=150 style="border: 1px solid rgba(0, 0, 0, 0.2);"}](/blog/2018-07-30_attention-layer/)
</aside>
...
<aside>
[![](showattendandtell.png){width=150 style="border: 1px solid rgba(0, 0, 0, 0.2);"}](/blog/2018-09-17_eager-captioning/)
</aside>
...
<aside>
[![](m.png){width=150 style="border: 1px solid rgba(0, 0, 0, 0.2);"}](/blog/2018-09-26_keydana2018embeddings-recommender/)
</aside>
...
<aside>
[![](thumb.png){width=150 style="border: 1px solid rgba(0, 0, 0, 0.2);"}](/blog/2018-08-26_keydana2018eagerdcgan/)
</aside>
...
<aside>
[![](pix2pixlosses.png){width=150 style="border: 1px solid rgba(0, 0, 0, 0.2);"}](/blog/2018-09-20_keydana2018eagerpix2pix/)
</aside>
