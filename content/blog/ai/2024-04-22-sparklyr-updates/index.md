...
<figure>
<img src="images/r-udfs.png" data-fig-alt="Diagram that shows how sparklyr transmits the R code via the rpy2 python package, and how Spark uses it to run the R code" width="600" alt="R code via rpy2" />
