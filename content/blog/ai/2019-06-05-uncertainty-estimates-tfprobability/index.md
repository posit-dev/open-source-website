...
<figure>
<img src="images/simdata.png" width="500" alt="Simulated data" />
<figcaption aria-hidden="true">Simulated data</figcaption>
</figure>
...
<figure>
<img src="images/g_aleatoric_relu_8.png" width="500" alt="Aleatoric uncertainty on simulated data, using relu activation in the first dense layer." />
<figcaption aria-hidden="true">Aleatoric uncertainty on simulated data, using relu activation in the first dense layer.</figcaption>
</figure>

This looks pretty reasonable. What if we had used linear activation in the first layer? Meaning, what if the model had looked like this[^2]:
...
<figure>
<img src="images/g_aleatoric_linear_8.png" width="500" alt="Aleatoric uncertainty on simulated data, using linear activation in the first dense layer." />
<figcaption aria-hidden="true">Aleatoric uncertainty on simulated data, using linear activation in the first dense layer.</figcaption>
</figure>
...
1.  fit the actual data well (put differently: achieve high *log likelihood*), and
2.  stay close to a *prior* (as measured by [KL divergence](https://en.wikipedia.org/wiki/Kullback%E2%80%93Leibler_divergence)).
...
<figure>
<img src="images/g_epistemic_linear_kl150.png" width="500" alt="Epistemic uncertainty on simulated data, using linear activation in the variational-dense layer." />
<figcaption aria-hidden="true">Epistemic uncertainty on simulated data, using linear activation in the variational-dense layer.</figcaption>
</figure>
...
<figure>
<img src="images/g_epistemic_relu.png" width="500" alt="Epistemic uncertainty on simulated data, using relu activation in the variational-dense layer." />
<figcaption aria-hidden="true">Epistemic uncertainty on simulated data, using relu activation in the variational-dense layer.</figcaption>
</figure>

However, things look pretty different if we drastically reduce training time... which brings us to the next observation.

1.  Unlike in the aleatoric setup, the number of training epochs matter *a lot*. If we train, *quote unquote*, too long, the posterior estimates will get closer and closer to the posterior mean: we lose uncertainty. What happens if we train "too short" is even more notable. Here are the results for the linear-activation as well as the relu-activation cases:

<figure>
<img src="images/g_epistemic_100epochs.png" width="1010" alt="Epistemic uncertainty on simulated data if we train for 100 epochs only. Left: linear activation. Right: relu activation." />
<figcaption aria-hidden="true">Epistemic uncertainty on simulated data if we train for 100 epochs only. Left: linear activation. Right: relu activation.</figcaption>
</figure>
...
<figure>
<img src="images/g_epistemic_100epochs.png" width="1010" alt="Epistemic uncertainty on simulated data. Left: kl_weight = 1. Right: prior non-trainable." />
<figcaption aria-hidden="true">Epistemic uncertainty on simulated data. Left: kl_weight = 1. Right: prior non-trainable.</figcaption>
</figure>
...
<figure>
<img src="images/g_both_scale0.01.png" width="500" alt="Displaying both epistemic and aleatoric uncertainty on the simulated dataset." />
<figcaption aria-hidden="true">Displaying both epistemic and aleatoric uncertainty on the simulated dataset.</figcaption>
</figure>
...
<figure>
<img src="images/g_both_scale_all.png" width="1515" alt="Epistemic plus aleatoric uncertainty on the simulated dataset: Varying the scale argument." />
<figcaption aria-hidden="true">Epistemic plus aleatoric uncertainty on the simulated dataset: Varying the scale argument.</figcaption>
</figure>
...
<figure>
<img src="images/uci_aleatoric.png" width="1010" alt="Aleatoric uncertainty on the Combined Cycle Power Plant Data Set; single predictors." />
<figcaption aria-hidden="true">Aleatoric uncertainty on the Combined Cycle Power Plant Data Set; single predictors.</figcaption>
</figure>
...
<figure>
<img src="images/uci_epistemic.png" width="1010" alt="Epistemic uncertainty on the Combined Cycle Power Plant Data Set; single predictors." />
<figcaption aria-hidden="true">Epistemic uncertainty on the Combined Cycle Power Plant Data Set; single predictors.</figcaption>
</figure>
...
<figure>
<img src="images/uci_both.png" width="1010" alt="Combined uncertainty on the Combined Cycle Power Plant Data Set; single predictors." />
<figcaption aria-hidden="true">Combined uncertainty on the Combined Cycle Power Plant Data Set; single predictors.</figcaption>
</figure>
...
<figure>
<img src="images/uci_allpreds_all.png" width="1515" alt="Uncertainty (aleatoric, epistemic, both) on the Combined Cycle Power Plant Data Set; all predictors." />
<figcaption aria-hidden="true">Uncertainty (aleatoric, epistemic, both) on the Combined Cycle Power Plant Data Set; all predictors.</figcaption>
</figure>
...
[^1]: see also the corresponding [notebook](https://colab.research.google.com/github/tensorflow/probability/blob/master/tensorflow_probability/examples/jupyter_notebooks/Probabilistic_Layers_Regression.ipynb#scrollTo=5zCEYpzu7bDX)

[^2]: yes, we also use that other line for `scale` that was commented before; more on that in a second
