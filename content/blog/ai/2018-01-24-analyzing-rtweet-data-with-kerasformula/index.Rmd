...
repository_url: https://github.com/rdrr1990/kms4tf/
preview: images/densities-1.png
format: hugo-md
categories:
  - Machine Learning
ported_categories:
...
![](images/first_model-1.png){width=100%}
...
plot(popularity$history) 
  + ggtitle(paste("#rstat popularity (custom dense neural net):",
            paste0(round(100*popularity$evaluations$acc, 1), "%"),
            "out-of-sample accuracy")) 
  + theme_minimal()
```
