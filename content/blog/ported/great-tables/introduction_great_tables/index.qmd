...
description: "A tour of the new Great Tables Python package — building structured tables, formatting cell values, applying targeted styles, and using Polars expressions for column selection."
people:
  - Rich Iannone
date: '2024-01-04'
freeze: true
