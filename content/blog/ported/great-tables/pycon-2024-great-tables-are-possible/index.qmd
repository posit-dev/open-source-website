...
Critically, the code for this table used the DataFrame library [Polars](https://pola.rs/), which makes it really [easy to select rows and columns for styling](/blog/2024-01-08_polars-styling/).
...
* [The Design Philosophy of Great Tables (blog post)](/blog/2024-04-04_design-philosophy/)
