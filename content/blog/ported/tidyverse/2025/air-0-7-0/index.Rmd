...
If you haven't heard of Air, read our [announcement blog post](/blog/2025-02-21_air/) first to get up to speed.
...
In [our release post](/blog/2025-02-21_air/#how-can-i-disable-formatting), we detailed how to disable formatting using a `# fmt: skip` comment for a single expression, or a `# fmt: skip file` comment for an entire file.
