...
As we mentioned in the [coming soon](/blog/2022-11-28_dplyr-1-1-0-is-coming-soon/) blog post, in dplyr 1.1.0 we've decided to walk back the change we introduced to `summarise()` in dplyr 1.0.0 that allowed it to return per-group results of any length, rather than results of length 1.
...
We also mentioned in the [coming soon](/blog/2022-11-28_dplyr-1-1-0-is-coming-soon/) post that `arrange()` has undergone two user-facing changes:
...
To read more about the exact differences between the C locale and locales like American English or Spanish, see the [coming soon](/blog/2022-11-28_dplyr-1-1-0-is-coming-soon/#arrange-improvements-with-character-vectors) post or our detailed [tidyup](https://github.com/tidyverse/tidyups/blob/main/003-dplyr-radix-ordering.md).
