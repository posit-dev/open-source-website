...
In [tidyr 1.3.0](/blog/2023-01-24_tidyr-1-3-0/#nestby), `nest()` gained a `.by` argument, allowing you to specify the columns you want to nest *by* rather than the columns that appear in the nested results, which often makes for more natural calls to `nest()`.
