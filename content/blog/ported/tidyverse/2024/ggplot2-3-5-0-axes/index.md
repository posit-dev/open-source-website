...
That wraps up the visible changes to axes for this post. To read about general changes, see the [main post](/blog/2024-02-23_ggplot2-3-5-0/). The changes to legends are covered in a [separate post](/blog/2024-02-26_ggplot2-3-5-0-legends/) and for the new polar coordinate system (and their axes) will be in a future post.
