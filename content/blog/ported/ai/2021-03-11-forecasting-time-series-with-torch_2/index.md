...
We pick up where the [first post in this series](/blog/2021-03-10_keydanatorchts1/) left us: confronting the task of multi-step time-series forecasting.
...
In `forward()`, we first apply the RNN, and just like in the previous post, we make use of the `outputs` only; or more specifically, the `output` corresponding to the final time step. (See that previous post for a [detailed discussion](/blog/2021-03-10_keydanatorchts1/#model) of what a `torch` RNN returns.)
...
<figure>
<img src="images/multistep_preds.png" width="600" alt="One-week-ahead predictions for January, 2014." />
<figcaption aria-hidden="true">One-week-ahead predictions for January, 2014.</figcaption>
</figure>
...
Photo by [Monica Bourgeau](https://unsplash.com/@monicabourgeau?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
