...
This changed in the [follow-up post](/blog/2020-10-05_keydanatorchnetworkwithautograd/). No more thinking about derivatives and the chain rule; a single call to `backward()` did it all.

[In the third post](/blog/2020-10-07_keydanatorchmodules/), the code again saw a major simplification. Instead of tediously assembling a DAG[^1] by hand, we let *modules* take care of the logic.
