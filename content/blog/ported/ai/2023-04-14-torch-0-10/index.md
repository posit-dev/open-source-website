...
<figure>
<img src="images/colab.png" alt="Colaboratory running torch" />
<figcaption aria-hidden="true">Colaboratory running torch</figcaption>
</figure>
...
If you are new to torch and want to learn more, we highly recommend the [recently announced](https://skeydan.github.io/Deep-Learning-and-Scientific-Computing-with-R-torch/) book 'Deep Learning and Scientific Computing with R `torch`'.
