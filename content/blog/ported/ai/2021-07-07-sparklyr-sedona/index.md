...
[mlverse survey results](/blog/2021-02-17_keydanasurvey2021/) earlier
...
<figure>
<img src="images/choropleth-map.png" alt="Example choropleth map output" />
...
<figure>
<img src="images/choropleth-map-with-overlay.png" alt="Choropleth map with overlay" />
...
[^1]: `sparklyr.sedona` was not released to CRAN yet at the time of writing.

[^2]: Yes, pun intended

[^3]: This demo requires sparklyr 1.7 or above to generate the required Spark SQL type casts for `ST_Point()` automatically.
