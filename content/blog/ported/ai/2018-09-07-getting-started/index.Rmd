...
[![Example from Deep Learning with R in motion, video 2.7, _From Derivatives to Gradients_](images/dl_in_motion.png){.l-body style="border: 1px solid rgba(0, 0, 0, 0.2);"}](https://bit.ly/2oPtXWv)
