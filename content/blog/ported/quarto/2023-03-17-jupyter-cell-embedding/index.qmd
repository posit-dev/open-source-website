...
![](embed-fig-bill-scatter.png){fig-alt="A scatterplot of bill_length_mm vs bill_depth_mm for the Palmer Penguins dataset, with points coloured by species (Adelie, Chinstrap, Gentoo). Caption: A scatterplot of bill dimensions for penguins, made with Altair. Source: penguins.ipynb."}
