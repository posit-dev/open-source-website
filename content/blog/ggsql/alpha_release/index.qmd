...
![](greet.png){fig-alt="Humorous SQL query greeting SQL users that aren't R and Python users as well: SELECT 'Hello' AS greetings FROM SQL_users WHERE other_language NOT IN ('R', 'Python')"}
...
![](epic_handshake.png){fig-alt="Epic handshake meme showing SQL and the grammar of graphics agreeing on declarative, composable operations"}
...
![](age.gif){fig-align="center" fig-alt="Titanic meme showing aged Rose saying 'It's been 84 years'"}
