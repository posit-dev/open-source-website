...
people:
  - Julia Silge
description: >
  Highlights from the 2026.08 release of Positron, including new SQL features, a better reproducible authoring experience, improved handling of missing packages, and more.
image: "featured.svg"
image-alt: "The Positron logo and wordmark in white on a dark navy background, with the words August Release Highlights below and a faint box plot pattern along the right edge."
topics:
  - Best Practices
...
![](data-connections.gif){fig-align="center" fig-alt="Browsing the schemas and tables of a DuckDB connection in the Data Connections panel, then opening a table in the Data Explorer to see its column profiles and data."}
...
![](inline-output-plot-metadata.png){fig-align="center" fig-alt="A Quarto document open in Positron with a Python cell that sets the fig-width and fig-height options, and the resulting matplotlib scatter plot rendered inline below the cell at that size."}
...
![](missing-package.gif){fig-align="center" fig-alt="A Shiny app in Positron showing a missing package button in the editor toolbar. Clicking it installs bslib in the console, and the app then runs with its bubble chart in the Viewer pane."}
