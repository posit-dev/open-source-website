...
- You need to specify it to directly predict survival probabilities, via `predict()` or `augment()`. We introduced the corresponding `eval_time` argument first for fitted models in [parsnip and censored](/blog/2023-04-19_censored-0-2-0/#introducing-eval_time) and have added it now for workflows. 
