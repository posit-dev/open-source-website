...
Please find the [main release post](/blog/2024-02-23_ggplot2-3-5-0/) to read about other exciting changes.
...
We realised we could not adapt `coord_polar()` to fit with the [new guide system](/blog/2024-02-23_ggplot2-3-5-0/#guide-rewrite) without severely breaking existing plots, so `coord_radial()` was born to give a facelift to the polar coordinate system in ggplot2.
...
More on these settings in the [axis blog](/blog/2024-02-28_ggplot2-3-5-0-axes/).
