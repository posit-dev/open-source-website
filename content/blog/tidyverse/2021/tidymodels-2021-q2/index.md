...
people:
  - Julia Silge
description: |
  Releases of tidymodels packages in Q2 of 2021 include more streamlined memory footprints for feature-engineering recipes, new model engine options, and better support for post-processing predictions.
photo:
