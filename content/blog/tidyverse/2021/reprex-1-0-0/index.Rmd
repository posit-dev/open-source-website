...
1.  The code was actually executed by the R interpreter, because this post is
    generated from an `.Rmd` document. I am probably not misleading you,
    intentionally or by accident, with fictional or incomplete code.
...
3.  If you do want to execute the code yourself, you can easily copy the entire
    chunk, paste it into R, and press enter[^2]. Compare that with the fussy
    edits you'd have to make with this copy/paste from the R Console:
...
`reprex::reprex()` aims to make doing the right thing so easy that people stop taking photos of broken code with their cell phone.
...
In addition to the articles there, reprex --- as a lifestyle 🤓 and a package 📦 --- features in my [rstudio::global(2020) keynote about debugging](https://github.com/jennybc/debugging#readme).
