...
Last summer I wrote a series of blog posts titled [teaching the tidyverse in 2020](/blog/2020-07-19_teaching-the-tidyverse-in-2020-part-4-when-to-purrr/).
...
-   <img src="lifecycle-superseded.svg" alt="Superseded" style="vertical-align:middle"/> Superseded indicates that there is a known better alternative for the function, but it's not going away.
    ...
    -   `tidyr::pivot_longer()` / `tidyr::pivot_wider()` for reshaping data supersede `tidyr::spread()` / `tidyr::gather()` (More on these [here](/blog/2019-09-13_tidyr-1-0-0/) and [here](https://tidyr.tidyverse.org/articles/pivot.html))

    -   `dplyr::across()` for working across columns supersedes scoped verbs such as `dplyr::mutate_if()`, `dplyr::select_at()`, `dplyr::rename_all()`, etc. (More on this [here](/blog/2020-04-03_dplyr-1-0-0-colwise/) and [here](https://dplyr.tidyverse.org/articles/colwise.html))

    -   `dplyr::slice_sample()` with `n` and `prop` arguments supersedes `dplyr::sample_n()` / `dplyr::sample_frac()` (More on this [here](/blog/2020-03-09_dplyr-1-0-0-is-coming-soon/#superseded-functions))
...
For more on updates in reprex, read the blog posts for the [1.0.0](/blog/2021-02-01_reprex-1-0-0/) and [2.0.0](/blog/2021-04-05_reprex-2-0-0/) releases.
...
A new version of [**readr**](/blog/2021-07-20_readr-2-0-0/#reading-multiple-files-at-once) was recently released, with lots of updates outlined in [this blog post](/blog/2021-07-20_readr-2-0-0/).
