...
![*Illustrative OpenTelemetry span structure shown in a Jaeger collector UI*](otel-screenshot.png)
...
This is optimized and is now a supported developer interface for programmatic use.
