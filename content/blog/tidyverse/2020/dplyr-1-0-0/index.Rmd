...
-   [Major lifecycle changes](/blog/tidyverse/2020/dplyr-1-0-0-is-coming-soon/). 
...
-   [New `summarise()` features](/blog/tidyverse/2020/dplyr-1-0-0-summarise/). 
...
-   [`select()`, `rename()`, and (new) `relocate()`](/blog/tidyverse/2020/dplyr-1-0-0-select-rename-relocate/). 
...
-   [Working `across()` columns](/blog/tidyverse/2020/dplyr-1-0-0-colwise/).
...
-   [Working within rows](/blog/tidyverse/2020/dplyr-1-0-0-rowwise/).
...
-   [The role of the vctrs package](/blog/tidyverse/2020/dplyr-1-0-0-and-vctrs/).
...
-   [Last minute additions](/blog/tidyverse/2020/dplyr-1-0-0-last-minute-additions/)
