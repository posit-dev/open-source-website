...
tags:
  - tidyverse
  - Programming
image: workflow-vs-script-wd.jpg
...
img <- image_read(here("content", "articles", "Burned_laptop_secumem_11.jpg"))
img %>%
  image_crop("1000x1000+300+200") %>%
  image_scale("300x300") %>%
  image_write("content/articles/workflow-vs-script-sq.jpg")
img %>%
  image_crop("1600x320+200+600") %>%
  image_scale("1000x200") %>%
  image_write("content/articles/workflow-vs-script-wd.jpg")
```
