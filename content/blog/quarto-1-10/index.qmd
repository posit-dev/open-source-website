...
people:
  - Charlotte Wickham
description: >
  Quarto 1.10 is a maintenance release packed with fixes, plus a few improvements: accessibility checks that work offline and can target a WCAG conformance level, and localized strings for use in custom templates.
image: thumbnail.png
image-alt: "The Quarto logo and the version number 1.10 in white on a steel blue background, with a hammer and wrench emoji above."
source: quarto
software:
  - quarto
languages:
...
The hammer and wrench emoji in the [listing and social card image](thumbnail.png) for this post comes from [OpenMoji](https://openmoji.org/){.external}– the open-source emoji and icon project. License: [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/#){.external}
