---
title: 'Multiple tables, saved conversations, and take-home dashboards: querychat R 0.4.0 and Python 0.9.0'
...
image: featured.png
image-alt: >-
  The querychat hex sticker above the headline "Chat across tables. Hand off
  the results." with cards for the R v0.4.0 and Python v0.9.0 releases, and a
  chat input reading "Type /handoff to turn this chat into a dashboard...".
topics:
