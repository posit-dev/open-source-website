...
![](images/commons-01-traffic-trend.gif "A commons agent answering a question with a trusted calculation."){fig-alt="A commons agent answers how site traffic is trending by finding and running a trusted calculation. The resulting chart and answer are marked as verified."}
...
![](images/shinychat-page-chat.png "A shinychat app built `page_chat()`."){.column-page fig-alt="A full-window Site traffic assistant built with page_chat, showing a traffic-trend question, a compact calculation activity row, the assistant's answer, and the chat input."}
...
![](images/shinychat-history.png "Previous conversations shown in the chat history sidebar."){.column-page fig-alt="The Site traffic assistant with its history sidebar open, showing controls to search or start a conversation and three saved traffic-analysis conversations beside the active chat."}
...
![](images/shinychat-tools-citations.png "A grouped activity row and an open citation."){fig-alt="A Shinychat answer with a compact grouped activity row for searching documentation and querying the warehouse, plus an open citation identifying sessions_daily as the canonical site-traffic source."}
