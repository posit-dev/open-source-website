...
image-alt: "Three hexagonal package logos: a colorful elephant for ellmer, overlapping chat bubbles for shinychat, and a common kingfisher beside a wetland for commons."
topics:
...
![](images/shinychat-page-chat.png){.column-page fig-alt="A full-window Site traffic assistant built with page_chat, showing a traffic-trend question, a compact calculation activity row, the assistant's answer, and the chat input."}
...
![](images/shinychat-history.png){.column-page fig-alt="The Site traffic assistant with its history sidebar open, showing controls to search or start a conversation and three saved traffic-analysis conversations beside the active chat."}
...
![](images/shinychat-tools-citations.png){fig-alt="A Shinychat answer with a compact grouped activity row for searching documentation and querying the warehouse, plus an open citation identifying sessions_daily as the canonical site-traffic source."}
