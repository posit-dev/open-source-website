...
image: feature.gif
image-alt: >-
  Shiny for Python 1.8: a code editor shows two pytest tests written against the
  local_server fixture, and a terminal below runs pytest and reports three tests
  passed with no browser started
topics:
  - Interactive Apps
software:
  - shiny-python
