"""Regenerate the post's feature images from feature-anim.html.

- feature.png (static fallback / social preview): the animation's final
  frame, captured at 1.6x device scale so the output is exactly 1920x1080
- feature.gif (animated, used as the post's `image`): frame-by-frame capture
  driven by the page's deterministic `seek(t)` function
...
SRC = (HERE / "feature-anim.html").as_uri()
...
with sync_playwright() as p:
    ...
    # Static poster -> feature.png at 1920x1080 (final resting frame)
