...
image: preview.png
image-alt: "Shiny logo beside a message composer card with toolbars in the card header and above the textarea."
topics:
  - Interactive Apps
software:
  - bslib
...
![Sales Data card with a header toolbar holding a region select toolbar dropdown and two toolbar buttons (swap and save), above a sales table.](card1.png)
...
![Quantity input with an inline toolbar in its label offering preset buttons (10, 50, 100) and a reset button.](card2.png)
...
![Message composer textarea with a submit-area toolbar (attach, priority flag, delete) and a Submit button, beside a message history panel.](card3.png)
