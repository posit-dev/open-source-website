...
::: column-body-outset
{{< video mortgage-calculator-1.mp4 title="Building a mortgage calculator with Shiny Assistant" >}}
:::
...
::: column-body-outset
{{< video mortgage-calculator-2.mp4 title="Adding a plot with remaining principal on the mortgage" >}}
:::
...
::: column-body-outset
{{< video mortgage-calculator-3.mp4 title="Editing code directly and restarting app" >}}
:::
...
::: column-body-outset
{{< video mortgage-calculator-4.mp4 title="Adding an amortization table" >}}
:::
...
![](r-python-switch.png){fig-alt="R/Python Switch" width="50%" fig-align="center"}
