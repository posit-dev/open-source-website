...
::: {.column-body-outset}
![](brand-yml-wide.svg){alt="brand.yml logo"}
:::

::: lead
We are bursting to announce that Shiny for Python now supports [brand.yml], a simple, unified theming experience through a single YAML file. 
:::
...
For example, you could use brand.yml to set the base font to [Roboto](https://fonts.google.com/specimen/Roboto) and use [orange]{style="padding-inline:0.25em; background-color: #f96302; color: white;"} as the primary accent color.
