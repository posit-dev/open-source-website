...
![A screenshot of a simple app that prompts for the user's name, and displays a greeting](hello-world.png){.border .img-fluid .figure-img}
...
![A screenshot of an app with a sidebar and a plot](plot.png){.border .img-fluid .figure-img}
...
::: {.column-page .py-3}
![A screenshot of a full-featured dashboard](tipping-dashboard.png){.border .img-fluid .figure-img}
