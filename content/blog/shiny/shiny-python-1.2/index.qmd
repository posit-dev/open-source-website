...
description: Shiny's `@render.data_frame` has a new integration with `narwhals`, gaining support for multiple data frame types!
people:
  - Shiny Team
date: "2024-10-31"
...
![PyArrow Table; 16,607 rows](pa-sp500.gif){.w-100}
:::

For a quick demo, Barret Schloerke will talk about the example above and more!

{{< video https://youtu.be/W-_0rkcuB_8 >}}
