...
In [Part 1: What LLMs Actually Do (and What They Don't)](https://shiny.posit.co/blog/posts/shiny-side-of-llms-part-1/), we looked at how large language models generate responses, why they sometimes seem so smart (and other times so confidently wrong), and what kinds of tasks they're actually good at. Now it's time to get hands-on!
...
And of course Claude believes that all the suggested improvements increase the relevant scores. However, don't be surprised if the numbers are off. Remember from [part 1](https://shiny.posit.co/blog/posts/shiny-side-of-llms-part-1/) that it's just a model that predicts a next token. It's good to do some sanity checks.
