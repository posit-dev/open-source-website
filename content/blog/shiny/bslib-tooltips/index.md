...
In [the last release of `bslib` (0.5.0)](https://shiny.posit.co/blog/posts/bslib-dashboards/), we made significant strides towards `bslib` being our recommended way to [build modern Shiny dashboards](https://rstudio.github.io/bslib/articles/dashboards/index.html).
