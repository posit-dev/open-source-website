...
description: Shiny v1.4 is now available on PyPI! This release includes bookmarking, new Generative AI documentation, and more.
people:
  - Shiny Team
date: "2025-04-15"
...
::: {.column-page-inset .py-3 .my-3}
![A screenshot of the [new Generative AI docs](https://shiny.posit.co/py/docs/genai-inspiration.html)](genai-docs.png){.shadow .rounded .lightbox}
:::
...
::: {.column-page-inset .py-3 .my-3}
![A screenshot of the [new Generative AI templates](https://shiny.posit.co/py/templates/)](genai-templates.png){.shadow .rounded .lightbox}
:::
