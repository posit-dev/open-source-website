...
To learn how to register tools and customize their display, see [Tool UI in shinychat for R](https://posit-dev.github.io/shinychat/r/articles/tool-ui.html) or [Tools in Shiny for Python](https://shiny.posit.co/py/docs/genai-tools.html).
