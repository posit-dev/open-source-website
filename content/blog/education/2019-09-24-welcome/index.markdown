...
Hello and welcome to the RStudio Education website! We hope to make [education.rstudio.com](https://education.rstudio.com/) a community resource for everyone who wants to [learn](https://education.rstudio.com/learn/) or [teach](https://education.rstudio.com/teach/) data science with R and RStudio.
...
+ [**Learn**.](https://education.rstudio.com/learn) Our advice for how learners can expand their knowledge about R and popular packages from RStudio, like tidyverse and Shiny. You'll find three learning pathways to help you become productive in the minimum amount of time, based on your experience level: [beginner](https://education.rstudio.com/learn/beginner), [intermediate](https://education.rstudio.com/learn/intermediate), and [expert](https://education.rstudio.com/learn/expert). The content and links on these pages may change as new resources become available and grab our attention. So rest assured &mdash; this page will be kept up-to-date, but that also means that our recommendations might change too.

+ [**Teach**.](https://education.rstudio.com/teach) Our team has trained a lot of learners to use R for data science. Drawing on that experience, we've broken down our collective advice and resources into three separable and learnable skills: how to [teach](https://education.rstudio.com/teach/how-to-teach) *(in general)*, how to create [materials](https://education.rstudio.com/teach/materials) to teach R and data science, and how to [set up effective learning environments](https://education.rstudio.com/teach/tools) for teaching R and data science.

+ [**Certify**.](https://education.rstudio.com/trainers) In 2019, we launched an instructor training and certification program that aims to help people apply modern evidence-based teaching practices to teach data science using R and RStudio’s products, and to help people who need such training find the trainers they need. On this [page](https://education.rstudio.com/trainers), you can meet our Certified Trainers and find out more about the program and the application process.
...
Who is the RStudio Education team? We are a small team of data scientists and professional educators. Our team is fully remote, spanning from Scotland to Oregon state. Meet each of us [here](https://education.rstudio.com/author/).
...
To find out more about the Education team's goal of adding the next million new R users to our community, you can watch this [rstudio::conf 2019 talk](https://resources.rstudio.com/rstudio-conf-2019/the-next-million-r-users) from RStudio's Director of Education, [Carl Howe](https://education.rstudio.com/authors/carl/).
...
In addition to the beautiful art, this site was built with ✨ CSS magic ✨ contributed by Robby Shaver, Greg Swinehart, and Desirée De Leon. Special thanks also to all the members of the [RStudio education team](https://education.rstudio.com/author), including our summer interns, who have contributed all the content here so far, and much more to come. 
