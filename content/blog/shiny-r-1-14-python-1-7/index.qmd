...
people:
  - Barret Schloerke
description: >
  Shiny for R v1.14, Shiny for Python v1.7, and bslib v0.12 are here! Hand
  your coding agent the keys to Shiny, run R apps without blocking your
  console, slide in offcanvas panels, and clean up dynamic modules with
  destroy().
image: "feature.gif"
