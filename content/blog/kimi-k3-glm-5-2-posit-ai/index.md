...
We're super stoked to share that two more open weights models—Kimi K3 and GLM 5.2—are now available as part of Posit AI. Both of these models are substantially cheaper than the proprietary models they feel most similar to. Notably, as well, these models are served much more quickly than Anthropic models; we've been seeing these models stream almost twice as many tokens per second in our internal testing, and working them is a qualitatively different feel. [As with the other models](https://docs.posit.co/posit-ai/user/faq/#privacy-data-storage) made available in Posit AI, your conversation histories will not be stored unless you choose to opt-in to data retention at sign-up.

Kimi K3 is currently the most capable open weights model out there. In our internal testing, it feels somewhere between Opus and Fable, and is notably well-rounded compared to other open weights releases. It's priced at the same price-per-token as Claude Sonnet 5.[^sonnet-pricing]
