...
Quarto 1.8 is available! You can get the current release from the [download page](https://quarto.org/docs/download/index.html).
...
You can read about these improvements and some other highlights below. You can find all the changes in this version in the [Release Notes](https://quarto.org/docs/download/changelog/1.8/).
...
Read more in the updated [Guide \> Brand](https://quarto.org/docs/authoring/brand.html):

- [Light and dark colors](https://quarto.org/docs/authoring/brand.html#light-and-dark-colors)
- [Light and dark logos](https://quarto.org/docs/authoring/brand.html#light-and-dark-logos)
- [Brand mode](https://quarto.org/docs/authoring/brand.html#brand-mode)
...
Read more in [Extensions \> Brand](https://quarto.org/docs/extensions/brand.html), and keep an eye out for other ways to reuse and share your brand in future releases.
...
- Access [metadata](https://quarto.org/docs/extensions/lua-api.html#metadata-access) and [variables](https://quarto.org/docs/extensions/lua-api.html#variables-access) in filters and shortcodes: Use the new `quarto.variables.get()` and `quarto.metadata.get()` APIs.
