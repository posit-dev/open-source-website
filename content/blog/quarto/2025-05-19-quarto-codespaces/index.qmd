...
description: 'In this post, I''ll teach you the basics of GitHub Codespaces and how
  to use them to make it easier to teach using Quarto.
...
- Dev Container
image: featured.png
image-alt: 'Quarto icon and text above GitHub Codespaces.
