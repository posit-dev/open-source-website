...
<img src="corvallis-add-tag.png" data-fig-alt="Screenshot of a Jupyter notebook cell with a tag &#39;parameters&#39; added to it." />
...
<figure>
<img src="corvallis-pretty-pdf.png" data-fig-alt="The `corvallis.ipynb` notebook rendered by Quarto to `pdf`. The document has dark green header with the city in white text and a map next to it with the location as an orange dot." alt="corvallis.pdf" />
<figcaption aria-hidden="true"><code>corvallis.pdf</code></figcaption>
</figure>
...
You can read more about setting and using parameters in [Guide \> Computations \> Parameters](https://quarto.org/docs/computations/parameters.html).
