...
The video below provides a taste of `querychat`'s core capabilities. It starts off with performing a filter action on the dashboard views, then follows that up with some querying and visualization to learn more about the data beyond what the predetermined views can show. [Source code](https://github.com/sol-eng/snowflake_demo/tree/main/apps/shiny-python-querychat) is available for reference, though you'll need your own Snowflake account and credentials to run it.
