...
image: featured.png
image-alt: "A querychat app showing a natural language conversation with inline ggsql visualizations and SQL query results"
topics:
...
::: callout-note
### Python users: Shiny v Streamlit/Dash/Gradio
