...
See `_link-checks.md` for:
- Instructions on running lychee
- How to interpret results (false positives vs real issues)
- Common link patterns to fix during porting
- Progress tracking by blog
- Documented broken external links
