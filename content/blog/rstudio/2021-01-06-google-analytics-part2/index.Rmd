...
description: In this post, I continue our series on how to create your own Google
  Analytics dashboard in R. Using the data we downloaded in our last post, we'll now
  create a simple dashboard showing blog page views over time and highlighting the
  most popular ones.
image: thumbnail.jpg
image-alt: Automobile Dashboard
blogcategories:
  - Data Science Leadership
...
We begin our dashboard by reading in the data from Google Analytics. <a href="/blog/2020-11-27_google-analytics-part1/" target="_blank" rel="noopener noreferrer">In our last post</a>, we built code to authenticate and read in the GA data using the Google Analytics API. In a production dashboard, we would put that code in the setup section here. 
