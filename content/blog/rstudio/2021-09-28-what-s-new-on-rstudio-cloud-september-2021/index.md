...
resources:
  - name: hero
    src: cloud-hero.png
    title: RStudio Cloud text logo
  - name: start
    src: jupyter-start.png
    title: Screenshot of new Jupyter notebook project option in RStudio Cloud
  - name: notebook
    src: jupyter-notebook.png
    title: Screenshot of Jupyter notebook in RStudio cloud
