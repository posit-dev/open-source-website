...
ggvis works seamlessly with [R Markdown v2](/blog/rstudio/r-markdown-v2/) and [interactive documents](/blog/rstudio/interactive-documents-an-incredibly-easy-way-to-use-shiny/), so you can easily add interactive graphics to your R Markdown documents:
