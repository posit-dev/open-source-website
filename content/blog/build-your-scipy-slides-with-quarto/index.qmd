...
<iframe class="slide-deck" src="slide-03.html#/1" loading="lazy" width="560" height="373"></iframe>
...
<iframe class="slide-deck" src="slide-04.html#/features-for-showing-code" loading="lazy" width="560" height="373"></iframe>

Continue adding new slides until you’re done!

### Add Python code cells

To add Python code to your slide, put it within a code cell, which is delineated by three backticks `` ``` `` and `python` within curly braces. By default, Quarto reveal.js presentations do not show your code cells, because they assume you are presenting just your output. If you do want to show your code, you can add a _cell option_, designated by a special comment, `#| `, followed by the option using YAML syntax. In this case, `echo: true` lets Quarto know to show the code.
...
<iframe class="slide-deck" src="slide-04b.html#/add-python-code-cells" loading="lazy" width="560" height="373"></iframe>
...
<iframe class="slide-deck" src="slide-04c.html#/code-output-is-included" loading="lazy" width="560" height="373"></iframe>
...
<iframe class="slide-deck" src="slide-05.html#/you-can-show-code-without-running-it" loading="lazy" width="560" height="373"></iframe>
...
<iframe class="slide-deck" src="slide-06.html#/highlight-lines-as-you-talk" loading="lazy" width="560" height="373"></iframe>
...
<iframe class="slide-deck" src="slide-07.html#/send-big-output-to-its-own-slide" loading="lazy" width="560" height="373"></iframe>
...
<iframe class="slide-deck" src="slide-08.html#/label-code-with-filenames" loading="lazy" width="560" height="373"></iframe>
