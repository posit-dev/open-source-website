...
We recommend using [Positron](https://positron.posit.co/) as your editor, since Quarto is preinstalled. If you are using VS Code, install the [Quarto VS Code Extension](https://marketplace.visualstudio.com/items?itemName=quarto.quarto).
