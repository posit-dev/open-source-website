...
With projects like [Great Tables](https://posit-dev.github.io/great-tables/) and [Pointblank](https://posit-dev.github.io/pointblank/), I wanted documentation sites that looked distinctive and match the character of each project. That desire led me to build [Great Docs](https://posit-dev.github.io/great-docs/), a documentation generator that produces attractive sites out of the box (but with simple options to customize the look and make it yours). Great Docs is now part of the [Posit](https://posit.co/) open-source ecosystem, [available on PyPI](https://pypi.org/project/great-docs/), and at `v0.6` with six releases since its initial soft launch.
