...
::: {.callout-note}
This week, we are busy preparing for posit::conf, so we're running an abbreviated version of a post Simon published on his personal blog. You can read the full version here:
:::
