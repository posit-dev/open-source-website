...
description: >
  Positron now includes a native Jupyter Notebook Editor in alpha, built from
  the ground up for data science workflows. Here's what is in alpha, why we
  build a new Notebook editor and what's coming next.
people:
  - Cindy Tong
date: '2026-03-16'
...
<figure>
<img src="positron-notebook.png" alt="Positron Notebook Editor" />
...
{{< video src="https://positron.posit.co/videos/notebook-data-explorer-variables.mp4" aria-label="Explore, sort and filter your dataframes in an embedded data explorer" >}}
...
{{< video src="https://positron.posit.co/videos/notebook-ai-quick-actions.mp4" aria-label="Using Positron Assistant to generate AI-powered suggestions and edits in a notebook" >}}
...
{{< video src="https://positron.posit.co/videos/notebook-help.mp4" aria-label="Access Python and R documentation inline in the Help pane without switching to a browser" >}}
...
{{< video src="https://positron.posit.co/videos/notebook-publish-connect.mp4" aria-label="Publish and share your notebook" >}}
